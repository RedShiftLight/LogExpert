...
namespace RegexColumnizer
{
    ...
    public class Regex2Columnizer : Regex1Columnizer { public string Text => "Regex 2"; }
    public class Regex3Columnizer : Regex1Columnizer { public string Text => "Regex 3"; }
    public class Regex4Columnizer : Regex1Columnizer { public string Text => "Regex 4"; }
    public class Regex5Columnizer : Regex1Columnizer { public string Text => "Regex 5"; }
    public class Regex6Columnizer : Regex1Columnizer { public string Text => "Regex 6"; }
    public class Regex7Columnizer : Regex1Columnizer { public string Text => "Regex 7"; }
    public class Regex8Columnizer : Regex1Columnizer { public string Text => "Regex 8"; }
    public class Regex9Columnizer : Regex1Columnizer { public string Text => "Regex 9"; }
}