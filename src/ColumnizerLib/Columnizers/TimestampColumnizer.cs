...
namespace LogExpert
{
    public class TimestampColumnizer : ILogLineColumnizer
    {
        ...
        public TimestampColumnizer()
        {
            timeStampColumn = 1;
        }

        #region ILogLineColumnizer implementation
        protected int timeStampColumn = 0;
        ...
        protected virtual FormatInfo DetermineDateTimeFormatInfo(ILogLine line)
        {
            string temp = line.FullLine;
        ...
        protected virtual FormatInfo DetermineTimeFormatInfo(string field)
        {
